...
public class Robot extends TimedRobot {
  ...
  CANSparkMax elevator = new CANSparkMax(5, MotorType.kBrushless);
  ...
  */
  ...
  public void robotInit() {
    ...
    elevatorEncoder.setPositionConversionFactor(10);
    elevatorEncoder.setVelocityConversionFactor(1000 / 60);

    arm.restoreFactoryDefaults();
    armEncoder.setPosition(0);
    armEncoder.setPositionConversionFactor(10);
    armEncoder.setVelocityConversionFactor(1000 / 60);

    intake.restoreFactoryDefaults();
    intakeEncoder.setPosition(0);
    intakeEncoder.setPositionConversionFactor(10);
